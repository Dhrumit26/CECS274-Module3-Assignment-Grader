...
DEFAULT_SUBMISSIONS = "downloads/CECS 274 SEC 01 3208 (Fall 2025)/Module 3_ Linked Lists"
DEFAULT_TESTS_DIR = "tests/m3"
DEFAULT_SUPPORT_DIR = "tests/m3"
...
TARGET_FILENAMES = {
    "BookStore.py", "Calculator.py", "DLLDeque.py", "DLList.py", "MaxQueue.py", "SLLQueue.py", "SLLStack.py"
}
# -------------------------------------------------------
